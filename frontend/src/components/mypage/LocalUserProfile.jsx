...
const LocalUserProfile = forwardRef(function LocalUserProfile({ user }, ref) {
  ...
  useImperativeHandle(
    ...
    [nickname, nicknameStatus, mentorRole, phone, desiredJob, birthDate, address, addressDetail, user.nickname, selectedFile, pendingDelete],
  )
  ...
  const readonlyClass = 'w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-sm text-gray-400 bg-gray-50 cursor-not-allowed'
      ...
      <div className="flex-1">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="text" value={user.username ?? ''} disabled className={readonlyClass} />
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="text" value={user.name ?? ''} disabled className={readonlyClass} />
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1.5">생년월일</label>
            <input
              type="date"
              value={birthDate}
              onChange={(e) => setBirthDate(e.target.value)}
              className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
        </div>
